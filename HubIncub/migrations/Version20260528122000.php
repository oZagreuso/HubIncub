...
final class Version20260528122000 extends AbstractMigration
{
    ...
    {
        return 'Add sample aperitif event for alumni and new incubators';
    }

    public function up(Schema $schema): void
    {
        // Sample event used to populate the public event listing and the front-page latest event card.
