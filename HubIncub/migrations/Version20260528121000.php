...
final class Version20260528121000 extends AbstractMigration
{
    ...
    {
        return 'Ajouter le projet de test de ligne de vêtements HubIncub';
    }

    public function up(Schema $schema): void
    {
        // Projet de test utilisé pour valider la liste publique des projets avec du contenu éditorial.
